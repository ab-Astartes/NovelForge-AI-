...
public class PipelineConfig {
    ...
    private volatile boolean runArchitect;
    private volatile boolean runPlanner;
    private volatile boolean runComposer;
    private volatile boolean runWriter;
    private volatile boolean runObserver;
    private volatile boolean runReflector;
    private volatile boolean runNormalizer;
    private volatile boolean runAuditor;
    private volatile boolean runReviser;

    private volatile int chapterWordsMin;       // minimum word count target
    private volatile int chapterWordsMax;       // maximum word count target
    ...
    public synchronized void setRunArchitect(boolean v) { this.runArchitect = v; }
    public boolean isRunPlanner() { return runPlanner; }
    public synchronized void setRunPlanner(boolean v) { this.runPlanner = v; }
    public boolean isRunComposer() { return runComposer; }
    public synchronized void setRunComposer(boolean v) { this.runComposer = v; }
    public boolean isRunWriter() { return runWriter; }
    public synchronized void setRunWriter(boolean v) { this.runWriter = v; }
    public boolean isRunObserver() { return runObserver; }
    public synchronized void setRunObserver(boolean v) { this.runObserver = v; }
    public boolean isRunReflector() { return runReflector; }
    public synchronized void setRunReflector(boolean v) { this.runReflector = v; }
    public boolean isRunNormalizer() { return runNormalizer; }
    public synchronized void setRunNormalizer(boolean v) { this.runNormalizer = v; }
    public boolean isRunAuditor() { return runAuditor; }
    public synchronized void setRunAuditor(boolean v) { this.runAuditor = v; }
    public boolean isRunReviser() { return runReviser; }
    public synchronized void setRunReviser(boolean v) { this.runReviser = v; }
    public int getChapterWordsMin() { return chapterWordsMin; }
    public synchronized void setChapterWordsMin(int v) {
    ...
    public synchronized void setChapterWordsMax(int v) {
    ...
    public synchronized void setAuditPassThreshold(double v) { this.auditPassThreshold = v; }
    ...
    public synchronized void reloadFromJson(java.nio.file.Path configFile) {
