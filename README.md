...
- **实力分布地图** — Voronoi 色块疆域图：势力范围、下辖归属、特点与风格标签、敌对/同盟关系线，从角色档案与正文自动挖掘（零 LLM 成本）
...
13. **实力分布地图** — Voronoi 色块疆域图 + 势力档案（范围/下辖/特点/风格）+ 敌对/同盟关系线（竞品均无此能力）
14. **智能取名** — 人物姓名 / 武功招式 / 道具 / 兵器 / 势力 / 坐骑 六类一键生成，6 种风格词库 + 寓意释义 + 关键字注入 + 排除现有角色重名（纯本地，零 AI 依赖）
